...
")
  ...
  (add-show-section stream)


(defun generate-mid-panel (stream whiteboard-code)
  "Genera el mid_panel con el código de la pizarra como parámetro"
  (format stream "
      <div id=\"mid_panel\">
        <div id=\"title\">
          <div class=\"label\">
            ...
            ~a  <!-- Aquí se inserta el código de la pizarra recibido como parámetro -->
...
(defun show-whiteboard (stream &key title content author)
  "Muestra la pizarra con contenido personalizado"
  (let ((whiteboard-code 
         (format nil "
            <section class=\"demo-section show\">
               ...
               <div class=\"demo-content-title\">~a</div>
               <div class=\"demo-content-body\">~a<p class=\"demo-quote-author\">~a</p></div>
            ...
            (or title "Lesson 1: Walk your own path")
            (or content "<p>People like to judge other people. This peer pressure can make you stray from the path you started to carve for your future.</p>")
            (or author "Joseph Nazoa"))))
    
    (generate-mid-panel stream whiteboard-code)))

(defun hide-whiteboard (stream)
  "Oculta la pizarra (la mantiene en el DOM pero no visible)"
  (let ((whiteboard-code 
         "<section class=\"demo-section hide\">
              <!-- Pizarra oculta pero presente en el DOM -->
          </section>"))
    
    (generate-mid-panel stream whiteboard-code)))

(show-whiteboard stream 
                 :title "Nueva lección" 
                 :content "<p>Este es un contenido completamente diferente.</p>"
                 :author "Anónimo")
